...
def test_inference():
    ...
    kmodel.add(tf.keras.layers.Dense(100, activation="relu", input_shape=(N,)))
    kmodel.add(tf.keras.layers.Dense(100, activation="softmax"))
    kmodel.add(tf.keras.layers.Dense(300, activation="tanh"))
    kmodel.add(tf.keras.layers.Dense(50, activation="sigmoid"))
    kmodel.add(tf.keras.layers.Dense(25, activation="softmax"))
