...
(\romannumeral 1) the main problem will be the author's ability to
program ResNet-50 on SpiNNaker,
(\romannumeral 2) implementing a Tensorflow backend is not a feasible
thing to do and (\romannumeral 3) the discovery of the MLPerf
...
In order to---one day, not as part of this project---integrate current
state of the art deep learning libraries with SpiNNaker, we think it
