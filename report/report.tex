...
Changes made to the inital project proposal are discussed.
...
%
% probably will be a keras like api, but api not the focus,
% bc first we have to find out if spiNNaker is viable
% solution for dl in the first place, before we can worry
% about an interface for machine learning researchers

%
% here write about MLPerf
