...
% run a test session with the big MLP for training

% and show the two examples from the without_shared_state branch to
% show the max we could scale

% describe algorithm

% still strides are an issue for matching backwards
%
% complex receive event callback
