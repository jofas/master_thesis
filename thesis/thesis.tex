...
at handling lots of packets, the peek of packets being on the fabric
at the same time is not high.
Too many packets on the fabric at the same time causes back-pressure
and the routers simply drops packets.
...
% TODO: how the prototype computes the timer offset

% TODO: figure showing how weights are conceptually bound to
%       connections and how each connection has its own weight(s)
%       (for both cnns and mlp)
