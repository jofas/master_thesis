...
The API of the prototype was designed to resemble the sequential
model of the Keras deep learning library \citep{keras}.
...
\begin{figure}
  ...
  \caption{Illustration of how a machine graph is generated by the
    ...
    generated when the predict method of the model is called.}
