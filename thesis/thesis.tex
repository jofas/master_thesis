...
been able to implement ResNet-50---the model we originally intended
to benchmark our prototype with
...
aware, namely application graphs, which can combine multiple neurons
...
has 512 filters.
The weights alone take up 9,216 Kb, far exceeding the available
...
on the board, therefore less resources, than the computationally less
demanding layers.
...
% start with good things and recount the awesome journey to this
% point in time

% then discuss the reset
