...
\ShortHeadings{Jonas Fassbender -- B160509}{\title}
...
\begin{center}
	...
	\end{tikzpicture}
\end{center}
\caption {Schema of an \acrshort{mlp} or feedforward neural network.}
\label{fig:mlp}
\end{figure} % }}}

An \acrshort{mlp} can also be represented as a statistical model
