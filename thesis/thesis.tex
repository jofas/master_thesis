...
% TODO: SDRAM, DTCM and shit into hardware section
...
% compiler and sark/event based model with callbacks and prio
% (maybe somewhat verbose: I want to discuss me spending too much
% time in receive callback)

\begin{itemize}
  \item global view (host, machine, what runs where and steps until it
    runs)
  \item MC-packets
  \item partitions
  \item workings of a neuron (event-based programming model)
  \item IO (Ethernet, SDP, RIPTMCS and LPG and LiveEventConnection)
\end{itemize}
