...
machine, as long as enough space is available to fit the copies onto
...
by machines as big as the SpiNNaker1M (see
Section~\ref{subsec:intro_spinn}), with over a million cores.

% is there more to write about multiple copies ????

% streaming and batch normalization layers

% here minor stuff from README and sharing gradients only before
% weight update
