...
process, once a outgoing edge partition has more than one key,
...
So the first key (one) generates an offset of one.
...
Both, the interface change and the bug together, could be solved in
a single day.

% here discuss minor deviations
