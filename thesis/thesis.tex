...
Also, thank is due to Victor Cosmor for being my rubber duck during
...
\begin{abstract}
  ...
  deep learning.
  This thesis investigates in how far deep learning can be realized on
  SpiNNaker.
...
a \acrshort{mlp} filling all the available cores on a SpiNN-5 board (see
...
Training a \acrshort{mlp} taking nearly every core of the SpiNN-5 board is also
possible.
