...
The error passed backward to the $j$th neuron of the previous layer
...
The $j$th neuron of layer $f^{(l-1)}$ sums its error over all
errors received from the neurons of the succeeding layer.
This process is continued until the neurons of first hidden layer
...
\begin{itemize}
  \item backward pass
  \item Conv1D: n keys for flattening, backprop, and stuff
\end{itemize}
