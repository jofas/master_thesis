...
In Section~\ref{sec:discussion}, a recap of the development phase and
the prototype is given, as well as ideas given which could potentially
solve the problems of the prototype.
