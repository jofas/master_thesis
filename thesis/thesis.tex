...
than relying on fast instruction level parallelism, for example with
optimized domain decomposition and smarter algorithms than matrix
multiplication.
